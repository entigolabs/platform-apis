...
const (
	...
	bucketSSEResJson               = `{"apiVersion":"s3.aws.m.upbound.io/v1beta1","kind":"BucketServerSideEncryptionConfiguration","metadata":{"labels":{"tenancy.entigo.com/zone":"zone-a"},"name":"%s"},"spec":{"forProvider":{"bucketRef":{"name":"%s"},"region":"eu-north-1","rule":[{"applyServerSideEncryptionByDefault":{"kmsMasterKeyId":"arn:aws:kms:eu-north-1:111111111111:key/mrk-data123","sseAlgorithm":"aws:kms"},"blockedEncryptionTypes":["SSE-C"], "bucketKeyEnabled":true}]},"initProvider":{},"providerConfigRef":{"kind":"ClusterProviderConfig","name":"aws-provider"}},"status":{"atProvider":{}}}`
	...
	iamPolicyResJson               = `{"apiVersion":"iam.aws.m.upbound.io/v1beta1","kind":"Policy","metadata":{"labels":{"tenancy.entigo.com/zone":"zone-a"},"name":"%s"},"spec":{"forProvider":{"policy":"{\"Statement\":[{\"Action\":[\"kms:Encrypt\",\"kms:Decrypt\",\"kms:ReEncrypt*\",\"kms:GenerateDataKey*\",\"kms:DescribeKey\"],\"Effect\":\"Allow\",\"Resource\":[\"arn:aws:kms:eu-north-1:111111111111:key/mrk-data123\"]},{\"Action\":[\"s3:PutObject\",\"s3:GetObject\",\"s3:GetObjectVersion\",\"s3:DeleteObject\",\"s3:AbortMultipartUpload\",\"s3:ListMultipartUploadParts\",\"s3:ListBucket\",\"s3:ListBucketMultipartUploads\",\"s3:GetBucketLocation\",\"s3:GetObjectTagging\",\"s3:PutObjectTagging\",\"s3:DeleteObjectTagging\",\"s3:GetObjectAcl\",\"s3:PutObjectAcl\"],\"Effect\":\"Allow\",\"Resource\":[\"arn:aws:s3:::%s\",\"arn:aws:s3:::%s/*\"]}],\"Version\":\"2012-10-17\"}","tags":{"Name":"%s","entigo:zone":"zone-a"}},"initProvider":{},"providerConfigRef":{"kind":"ClusterProviderConfig","name":"aws-provider"}},"status":{"atProvider":{}}}`
