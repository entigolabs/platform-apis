module github.com/entigolabs/function-base
...
replace github.com/hashicorp/terraform-provider-aws => github.com/upbound/terraform-provider-aws v0.0.0-20250731103852-29e0c58e5a84

require (
	github.com/crossplane/crossplane-runtime v1.20.0 // Other dependencies should match versions used in crossplane-runtime
	github.com/crossplane/function-sdk-go v0.5.0-rc.0.0.20250715215746-ca27889cd196
	github.com/google/go-cmp v0.7.0
	github.com/mozillazg/go-unidecode v0.2.0
	github.com/upbound/provider-aws v1.23.0 // indirect
