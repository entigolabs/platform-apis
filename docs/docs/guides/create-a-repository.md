...
Create an Repository manifest and deploy it to the cluster. It is a good practice to manage zones using GitOps methodology, similar to how applications are deployed.
