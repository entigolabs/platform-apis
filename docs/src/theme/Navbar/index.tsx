...
export default function Navbar(): JSX.Element | null {
    ...
    return (
        <nav className={ classNames('navbar custom-navbar') }>
                                        ...
                                        { link.__typename === 'ComponentNavbarMultipleLinks' && (
                                            ...
                                            >
                                                <div className="d-flex flex-align-items-center cursor-pointer">
                                                    <p className={ classNames('text-size-14 text-line-20 text-weight-600 pb-32 pt-32 mr-8 m-0 nav-multiple-link-title') }>
                                                        { link.text }
                                                    </p>
                                                    <CheckmarkIcon className="checkmark-icon nav-multiple-link-title" />
                                                </div>
                        ...
                        <div key={ index + link.text }>
                            ...
                            { link.__typename === 'ComponentNavbarMultipleLinks' && (
                                <div className="d-flex flex-column position-relative">
                                    ...
                                    >
                                        <p className="text-size-18 text-line-20 pb-32 pt-32 mr-8 m-0 nav-multiple-link-title">
                                            { link.text }
                                        </p>
                                        <CheckmarkIcon className="checkmark-icon nav-multiple-link-title" />
                                    </div>
