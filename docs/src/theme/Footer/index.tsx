...
export default function Footer(): JSX.Element | null {
    ...
    const getLinkColorClass = (href: string) => {
        ...
        return 'text-bright-blue hover-text-entigo-blue';
    };

    // Helper for text color
    const getTextColorClass = () => 'text-light-grey';

    return (
        <footer className={classNames('footer-custom background-dark')}>
            <div className="container">

                {/* 1. TOP LINKS SECTION */}
                <div className="row pt-36 pb-36 bottom-border-grey">
